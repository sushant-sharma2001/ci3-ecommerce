                              ...
                              <div class="row align-items-center">
                                 ...
                                 <div class="col-xl-7 col-lg-6 col-md-6">
                                    <div class="tp-slider-thumb text-end">
                                       <img src="uploads/<?= $banner->bann_image ?>" alt="slider-img">
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="tp-product-category-item text-center mb-40">
                              <div class="tp-product-category-thumb fix">
                                 <a href="shop-category.html">
                                    <img src="uploads/<?=$category->cate_image?>" class="img-fluid" alt="product-category">
                                 </a>
                              </div>
                              <div class="tp-product-category-content">
                                 <h3 class="tp-product-category-title">
                                    <a href="shop-category.html"><?= $category->cate_name ?></a>
                                 </h3>
                                 <p> Product</p>
                              </div>
                           </div>
                              ...
                              <div class="row">
                                 <?php if(!empty($products)){ 
                                          foreach($products as $product){ 
                                             $cate_name = $this->hm->category_name($product->category);
                                 ?>
                                                ...
                                                <div class="tp-product-item p-relative transition-3 mb-25">
                                                   ...
                                                   <div class="tp-product-content">
                                                      ...
                                                      <div class="tp-product-price-wrapper">
                                                         <span class="tp-product-price old-price">&#8377;<?=number_format($product->mrp)?></span>
                                                         <span class="tp-product-price new-price">&#8377;<?=number_format($product->selling_price)?></span>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>      
