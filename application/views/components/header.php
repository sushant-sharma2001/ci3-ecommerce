        ...
        <div data-simplebar class="vertical-scroll">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="category-index" class="waves-effect">
                            <i class="uim uim-airplay"></i>
                            <span>Category</span>
                        </a>
                    </li>
                    <li>
                        <a href="pincode-index" class="waves-effect">
                            <i class="uim uim-airplay"></i>
                            <span>Pincode</span>
                        </a>
                    </li>
                    <li>
                        <a href="banner-index" class="waves-effect">
                            <i class="uim uim-airplay"></i>
                            <span>Banner</span>
                        </a>
                    </li>
                    <li>
                        <a href="product-index" class="waves-effect">
                            <i class="uim uim-airplay"></i>
                            <span>Product</span>
                        </a>
                    </li>
