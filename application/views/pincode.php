                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="" placeholder="Enter pincode" name="pincode" value="<?=set_value('pincode');?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="" placeholder="delivery charge" name="deliver_charge" value="<?=set_value('deliver_charge');?>">
                                            <label for="">Delivery Charges</label>
                                        </div>
                                        <?=form_error('deliver_charge','<p class="text-danger">','</p>');?>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
